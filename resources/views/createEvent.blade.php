...
@section('content')
        <h1 class="page-header">{{ trans('messages.addEventHeading') }}</h1>
        @if (count($errors) > 0)
        ...
        <form id="addEventFrm" action="{{ url('/event/save') }}" method="post">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <label class="radio-inline"><input type="radio" name="payment" value="cash" checked="checked">{{ trans('messages.editEventPaymentLabelCash') }}</label>
                    <label class="radio-inline"><input type="radio" name="payment" value="bank">{{ trans('messages.editEventPaymentLabelBank') }}</label>
                    <label class="radio-inline"><input type="radio" name="payment" value="creditcard">{{ trans('messages.editEventPaymentLabelCreditcard') }}</label>
                    <label class="radio-inline"><input type="radio" name="payment" value="paypal">{{ trans('messages.editEventPaymentLabelPaypal') }}</label>
                    <label class="radio-inline"><input type="radio" name="payment" value="invoice">{{ trans('messages.editEventPaymentLabelInvoice') }}</label>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-md-6">
            ...
            <div class="row">
                <div class="form-group col-md-3">
                    ...
                    <label class="radio-inline"><input type="radio" name="tuning" value="yes">{{ trans('messages.editEventTuningLabelYes') }}</label>
                    <label class="radio-inline"><input type="radio" name="tuning" value="no" checked="checked">{{ trans('messages.editEventTuningLabelNo') }}</label>
                </div>
                <div class="form-group col-md-3">
                    <label for="dyno" >{{ trans('messages.editEventDynoLabel') }}</label><br />
                    <label class="radio-inline"><input type="radio" name="dyno" value="yes">{{ trans('messages.editEventDynoLabelYes') }}</label>
                    <label class="radio-inline"><input type="radio" name="dyno" value="no" checked="checked">{{ trans('messages.editEventDynoLabelNo') }}</label>
                </div>
                <div class="form-group col-md-6">
            ...
            <div class="form-group">
                <button type="button" id="btnCreate" class="btn btn-primary btn-lg btn-block">{{ trans('messages.addEventUpdateButton') }}</button>
            </div>
        </form>
@endsection
